          ...
          return e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(
                  n.AnchorLink,
                  { to: '#usethrottlefn', 'aria-hidden': 'true', tabIndex: -1 },
                  e.createElement('span', { className: 'icon icon-link' }),
                ),
                'useThrottleFn',
              ),
              e.createElement('p', null, '\u5BF9\u51FD\u6570\u8FDB\u884C\u8282\u6D41\u5904\u7406'),
              e.createElement(
                'h3',
                { id: '\u7C7B\u578B\u58F0\u660E' },
                e.createElement(
              ...
              e.createElement(c.Z, {
                code: 'function useThrottleFn(handler: (...args: any[]) => any, wait?: number, isImmediate?: boolean): [DebounceFn, Cancel]',
                lang: 'typescript',
              }),
              e.createElement(
                'h3',
