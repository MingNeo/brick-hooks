          ...
          return e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(
                  o.AnchorLink,
                  { to: '#usecookie', 'aria-hidden': 'true', tabIndex: -1 },
                  e.createElement('span', { className: 'icon icon-link' }),
                ),
                'useCookie',
              ),
              e.createElement('p', null, '\u65B9\u4FBF\u4F7F\u7528 cookie'),
              e.createElement(
                'h3',
                { id: '\u7C7B\u578B\u58F0\u660E' },
                e.createElement(
              ...
              e.createElement(a.Z, {
                code: `function useCookie(key: string): [
  string,
  SetItem,
  {
    get: () => string
...
const SetItem: (
  ...
  options: {
    ...
    path: any
              ...
              e.createElement(a.Z, {
                code: `const [userCookie, updateUserCookie, userCookieAPi] = useCookie('userName')
        ...
        return (
          e.useEffect(() => {
            ...
            u != null &&
              ...
              t !== void 0 &&
              t.hash &&
              o.AnchorLink.scrollToAnchor(decodeURIComponent(u.location.hash.slice(1)))
          }, []),
