          ...
          return e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(
                  t.AnchorLink,
                  { to: '#uselazyimage', 'aria-hidden': 'true', tabIndex: -1 },
                  e.createElement('span', { className: 'icon icon-link' }),
                ),
                'useLazyImage',
              ),
              e.createElement('p', null, '\u81EA\u52A8\u5BF9\u56FE\u7247\u8FDB\u884C\u61D2\u52A0\u8F7D\u5904\u7406'),
              e.createElement(
                'h3',
                { id: '\u7C7B\u578B\u58F0\u660E' },
                e.createElement(
