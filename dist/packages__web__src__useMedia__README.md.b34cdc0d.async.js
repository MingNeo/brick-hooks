          ...
          return e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(
                  n.AnchorLink,
                  { to: '#usemedia', 'aria-hidden': 'true', tabIndex: -1 },
                  e.createElement('span', { className: 'icon icon-link' }),
                ),
                'useMedia',
              ),
              e.createElement('p', null, '\u901A\u8FC7 js \u65B9\u4FBF\u4F7F\u7528\u5A92\u4F53\u67E5\u8BE2'),
              e.createElement(
                'p',
                null,
              ...
              e.createElement(l.Z, {
                code: 'function useMedia<T = any>(mediaQueryValueList: MediaQueryValueList, initialValue?: T): T',
                lang: 'typescript',
              }),
              e.createElement(l.Z, {
                code: `// \u6805\u683C\u5E03\u5C40\u65F6\uFF0C\u4E0D\u540C\u5C3A\u5BF8\u4F7F\u7528\u4E0D\u540C\u7684\u5BBD\u5EA6
