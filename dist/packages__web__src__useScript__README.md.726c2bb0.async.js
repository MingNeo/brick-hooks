;(self.webpackChunk_brick_hooks_root = self.webpackChunk_brick_hooks_root || []).push([
          ...
          return e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(
                  t.AnchorLink,
                  { to: '#usescript', 'aria-hidden': 'true', tabIndex: -1 },
                  e.createElement('span', { className: 'icon icon-link' }),
                ),
                'useScript',
              ),
              e.createElement('p', null, '\u5411\u9875\u9762\u4E2D\u63D2\u5165\u4E00\u4E2A script \u6587\u4EF6'),
              e.createElement(
                'h3',
                { id: '\u7C7B\u578B\u58F0\u660E' },
                e.createElement(
  ...
  return <Child>...</Child>
              ...
              e.createElement('p', null, '\u4E5F\u53EF\u4EE5\u4F7F\u7528 onLoaded'),
              e.createElement(u.Z, {
                code: `function MyComponent() {
  ...
  const handleClick = async () => {
    ...
    // ...
              ...
              e.createElement(u.Z, {
                code: `// http://xxx.cdn.com/moment.js \u53EA\u4F1A\u63D2\u5165\u4E00\u6B21
