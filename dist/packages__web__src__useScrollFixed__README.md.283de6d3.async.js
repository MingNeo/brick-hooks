;(self.webpackChunk_brick_hooks_root = self.webpackChunk_brick_hooks_root || []).push([
          ...
          return e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(
                  n.AnchorLink,
                  { to: '#usefixed', 'aria-hidden': 'true', tabIndex: -1 },
              ...
              e.createElement(a.Z, {
                code: `function useScrollFixed(options?: {
  ...
  rootRef: MutableRefObject<any>
              ...
              e.createElement(
                ...
                e.createElement(
                  n.AnchorLink,
                  { to: '#\u76F8\u5BF9-window', 'aria-hidden': 'true', tabIndex: -1 },
                  e.createElement('span', { className: 'icon icon-link' }),
                ),
                '\u76F8\u5BF9 window',
              ),
...
function Comp() {
  ...
  return <div ref={targetRef} className={isFixed ? 'fixed' : ''}></div>
              ...
              e.createElement(
                'h4',
                { id: '\u6307\u5B9A-root-\u5E76\u8865\u5145-fixed-\u65F6\u6837\u5F0F' },
                e.createElement(
                  n.AnchorLink,
                  {
                    to: '#\u6307\u5B9A-root-\u5E76\u8865\u5145-fixed-\u65F6\u6837\u5F0F',
                    'aria-hidden': 'true',
                    tabIndex: -1,
                  },
                  e.createElement('span', { className: 'icon icon-link' }),
