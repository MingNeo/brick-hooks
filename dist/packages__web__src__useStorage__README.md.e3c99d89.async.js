          ...
          return e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(
                  a.AnchorLink,
                  { to: '#usestorage', 'aria-hidden': 'true', tabIndex: -1 },
                  e.createElement('span', { className: 'icon icon-link' }),
                ),
                'useStorage',
              ),
              e.createElement('p', null, '\u65B9\u4FBF\u4F7F\u7528 localStorage \u548C sessionStorage'),
              e.createElement(
                'h3',
                { id: '\u7C7B\u578B\u58F0\u660E' },
                e.createElement(
...
setCacheUserInfo({ userName: 'klose' })`,
              ...
              e.createElement(
                'h3',
                { id: 'uselocalstorage--usesessionstorage' },
                e.createElement(
                  a.AnchorLink,
                  { to: '#uselocalstorage--usesessionstorage', 'aria-hidden': 'true', tabIndex: -1 },
                  e.createElement('span', { className: 'icon icon-link' }),
                ),
              ...
              e.createElement(o.Z, {
                code: "const [cacheUserInfo, setCacheUserInfo, { clear }] = useSessionStorage('user', {})",
                lang: 'javascript',
              }),
            ),
          )
