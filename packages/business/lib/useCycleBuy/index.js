...
var common_1 = require("@bricks-hooks/common");
...
function useDateCycle(defaultData, options) {
    ...
    var _f = __read(common_1.useMethods(methods, {
        dates: defaultDates || [],
        model: defaultModel,
        cycle: defaultCycle,
    ...
    var prevModel = common_1.usePrevious(model);
    var prevCycle = common_1.usePrevious(cycle);
