...
exports.removeStorage = exports.parseValue = exports.getStorage = exports.setStorage = void 0;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 7]);
                    return [4 /*yield*/, async_storage_1.default.setItem(key, JSON.stringify(value))];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 7];
                case 2:
                ...
                case 3:
                    ...
                    return [3 /*break*/, 6];
                case 4:
                    if (!(typeof value === 'number')) return [3 /*break*/, 6];
                    return [4 /*yield*/, async_storage_1.default.setItem(key, "" + value)];
                case 5:
                    _a.sent();
                    _a.label = 6;
