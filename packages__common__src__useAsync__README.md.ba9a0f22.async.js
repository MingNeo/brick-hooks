          ...
          return u.createElement(
            ...
            u.createElement(
              ...
              u.createElement(
                ...
                u.createElement(
                  e.AnchorLink,
                  { to: '#useasync', 'aria-hidden': 'true', tabIndex: -1 },
              ...
              u.createElement(n.Z, {
                code: `function useAsync<A extends AsyncFunction>(
  asyncFunction: A,
  {
    immediate,
    onResult,
  ...
  (...args: any[]) => Promise<any>,
  {
    ...
    mutate: (...args: any[]) => any
              ...
              u.createElement(
                ...
                u.createElement(
                  e.AnchorLink,
                  { to: '#\u81EA\u52A8\u89E6\u53D1\u8BF7\u6C42', 'aria-hidden': 'true', tabIndex: -1 },
                  u.createElement('span', { className: 'icon icon-link' }),
                ),
                '\u81EA\u52A8\u89E6\u53D1\u8BF7\u6C42',
              ),
              u.createElement(n.Z, {
                code: `const fetchData = (params) => {
...
function MyComponent() {
  ...
  return null
              ...
              u.createElement(
                ...
                u.createElement(
                  e.AnchorLink,
                  { to: '#\u624B\u5DE5\u89E6\u53D1\u8BF7\u6C42', 'aria-hidden': 'true', tabIndex: -1 },
                  u.createElement('span', { className: 'icon icon-link' }),
                ),
                '\u624B\u5DE5\u89E6\u53D1\u8BF7\u6C42',
              ),
  ...
  useEffect(() => {
    loadData().then((result) => {})
              ...
              u.createElement(
                ...
                u.createElement(
                  e.AnchorLink,
                  { to: '#debounce', 'aria-hidden': 'true', tabIndex: -1 },
                  u.createElement('span', { className: 'icon icon-link' }),
                ),
                'debounce',
              ),
              u.createElement(
                'p',
                null,
                '\u4F7F\u7528 debounceTime \u65F6\uFF0C\u5C06\u81EA\u52A8\u8FDB\u884C debounce \u5904\u7406 \u6CE8\u610F\uFF0C\u4F7F\u7528 debounceTime \u540E, \u8BF7\u6C42\u51FD\u6570 \u4E0D\u4F1A\u518D\u6709\u8FD4\u56DE\u503C',
              ),
              u.createElement(n.Z, {
                code: `// \u4F7F\u7528debounce
const [loadData, { loading, result }] = useAsync(fetchData, { debounceTime: 500 })`,
              ...
              u.createElement(n.Z, {
                code: `// \u4F7F\u7528debounceTime\u540E, loadData\u4E0D\u4F1A\u518D\u6709\u8FD4\u56DE\u503C\u3002\u53EF\u4EE5\u901A\u8FC7result\u83B7\u53D6\u7ED3\u679C\u3002\u6216\u5982\u4E0B\u5BF9retchData\u8FDB\u884C\u5305\u88C5
const [loadData, { loading, result }] = useAsync(
  ...
  { debounceTime: 500 }
              ...
              u.createElement(
                ...
                u.createElement(
                  e.AnchorLink,
                  { to: '#onresult', 'aria-hidden': 'true', tabIndex: -1 },
                  u.createElement('span', { className: 'icon icon-link' }),
                ),
                'onResult',
              ),
...
const [loadData, { loading, result }] = useAsync(fetchData, {
  onResult: (data) => setAddress({ addressList: data }),
              ...
              u.createElement(
                ...
                u.createElement(
                  e.AnchorLink,
                  { to: '#mutate', 'aria-hidden': 'true', tabIndex: -1 },
                  u.createElement('span', { className: 'icon icon-link' }),
                ),
                'mutate',
              ),
        ...
        return (
          u.useEffect(() => {
            ...
            t != null &&
              ...
              c !== void 0 &&
              c.hash &&
              e.AnchorLink.scrollToAnchor(decodeURIComponent(t.location.hash.slice(1)))
          }, []),
          u.createElement(s, { demos: r })
        )
      }
    },
  },
