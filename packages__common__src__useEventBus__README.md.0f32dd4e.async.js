          ...
          return u.createElement(
            ...
            u.createElement(
              ...
              u.createElement(
                ...
                u.createElement(
                  e.AnchorLink,
                  { to: '#useeventbus', 'aria-hidden': 'true', tabIndex: -1 },
              ...
              u.createElement(
                ...
                u.createElement(
                  e.AnchorLink,
                  { to: '#\u76F4\u63A5\u4F7F\u7528\u5168\u5C40-bus', 'aria-hidden': 'true', tabIndex: -1 },
                  u.createElement('span', { className: 'icon icon-link' }),
                ),
                '\u76F4\u63A5\u4F7F\u7528\u5168\u5C40 bus',
              ),
              ...
              u.createElement('p', null, '\u4F7F\u7528 useEventBus'),
              u.createElement(t.Z, {
                code: `import { useEventBus } from 'brick-hooks'
function Component1() {
...
const handleChange = (payload) => publish('loginEventBus', payload)`,
              ...
              u.createElement('p', null, '\u8FD4\u56DE\u6307\u5B9A\u4E8B\u4EF6\u7684useSubscribe\u3001publish'),
              u.createElement(t.Z, {
                code: `import { useEventBus } from 'brick-hooks'
function Component1() {
...
function Component2() {
  ...
  const handleChange = (payload) => publish(payload)
              ...
              u.createElement('p', null, '\u76F4\u63A5\u4F7F\u7528 \u5168\u5C40useSubscribe\u3001publish'),
              u.createElement(t.Z, {
                code: `import { useSubscribe, publish } from 'brick-hooks'
function Component1() {
  useSubscribe(('loginEventBus', payload) => {
    // ...
  })
...
function Component2() {
  ...
  return <Child onClick={handleChange} />;
              ...
              u.createElement(
                'h3',
                { id: '\u521B\u5EFA\u4E00\u4E2A\u72EC\u7ACB\u7684-eventbus-\u5B9E\u4F8B\u53CA\u76F8\u5173-hooks' },
                u.createElement(
                  e.AnchorLink,
                  {
                    to: '#\u521B\u5EFA\u4E00\u4E2A\u72EC\u7ACB\u7684-eventbus-\u5B9E\u4F8B\u53CA\u76F8\u5173-hooks',
                    'aria-hidden': 'true',
                    tabIndex: -1,
                  },
                  u.createElement('span', { className: 'icon icon-link' }),
              ...
              u.createElement(
                'p',
                null,
                '\u901A\u8FC7 createEventBus \u521B\u5EFA\u4E00\u4E2A\u72EC\u7ACB\u7684 eventBus \u5B9E\u4F8B\uFF0C\u5373\u53EF\u4E0E\u5168\u5C40\u7684 eventBus \u9694\u79BB\u5F00\u6765 \u5982\u679C\u4F7F\u7528ssr\uFF0C\u5219\u5FC5\u987B\u4F7F\u7528\u72EC\u7ACBeventBus \u5B9E\u4F8B\uFF0C\u63A8\u8350\u76F4\u63A5\u4F7F\u7528createContextEventBus',
              ),
              u.createElement(t.Z, {
                code: `import { createEventBus } from 'brick-hooks'
const { publish, useSubscribe, useEventBus } = createEventBus()`,
              ...
              u.createElement(
                'h3',
                {
                  id: '\u521B\u5EFA\u4E00\u4E2A\u72EC\u7ACB\u7684\u4E14\u4F7F\u7528-react-context-\u7684-eventbus-\u53CA\u76F8\u5173-hooks',
                },
                u.createElement(
                  e.AnchorLink,
                  {
                    to: '#\u521B\u5EFA\u4E00\u4E2A\u72EC\u7ACB\u7684\u4E14\u4F7F\u7528-react-context-\u7684-eventbus-\u53CA\u76F8\u5173-hooks',
                    'aria-hidden': 'true',
                    tabIndex: -1,
                  },
                  u.createElement('span', { className: 'icon icon-link' }),
              ...
              u.createElement(t.Z, {
                code: `import { createContextEventBus } from 'brick-hooks'
