...
)`,lang:"javascript"}),e.createElement(t.Z,{code:`// result
{
  1: { id: 1, value: 0 },
  2: { id: 2, value: 1 }
}`,lang:"javascript"}),e.createElement("h5",{id:"transtree-\u6570\u7EC4\u8F6C\u4E3A\u6811"},e.createElement(a.AnchorLink,{to:"#transtree-\u6570\u7EC4\u8F6C\u4E3A\u6811","aria-hidden":"true",tabIndex:-1},e.createElement("span",{className:"icon icon-link"})),"transTree \u6570\u7EC4\u8F6C\u4E3A\u6811"),e.createElement("h5",{id:"\u7C7B\u578B\u58F0\u660E"},e.createElement(a.AnchorLink,{to:"#\u7C7B\u578B\u58F0\u660E","aria-hidden":"true",tabIndex:-1},e.createElement("span",{className:"icon icon-link"})),"\u7C7B\u578B\u58F0\u660E"),e.createElement(t.Z,{code:`transTree(data: Record<string, any>[], { parentId, id, children }?: {
  parentId?: string;
  id?: string;
  children?: string;
...
]`,lang:"javascript"}),e.createElement("h5",{id:"group-\u5206\u7EC4"},e.createElement(a.AnchorLink,{to:"#group-\u5206\u7EC4","aria-hidden":"true",tabIndex:-1},e.createElement("span",{className:"icon icon-link"})),"group \u5206\u7EC4"),e.createElement(t.Z,{code:`const initialValue = [
...
}`,lang:"javascript"}),e.createElement("h5",{id:"partition-\u5206\u7EC4"},e.createElement(a.AnchorLink,{to:"#partition-\u5206\u7EC4","aria-hidden":"true",tabIndex:-1},e.createElement("span",{className:"icon icon-link"})),"partition \u5206\u7EC4"),e.createElement(t.Z,{code:`const initialValue = [
  { id: 'q1', city: 'qingdao', value: 0 },
  { id: 'q2', city: 'qingdao', value: 1 },
  { id: 'h1', city: 'hangzhou', value: 2 },
  { id: 'h2', city: 'hangzhou', value: 3 },
...
]`,lang:"javascript"}),e.createElement("h5",{id:"removebyid-\u6839\u636E-id-\u79FB\u9664\u6570\u636E"},e.createElement(a.AnchorLink,{to:"#removebyid-\u6839\u636E-id-\u79FB\u9664\u6570\u636E","aria-hidden":"true",tabIndex:-1},e.createElement("span",{className:"icon icon-link"})),"removeById \u6839\u636E id \u79FB\u9664\u6570\u636E"),e.createElement(t.Z,{code:`const initialValue = [
  { id: 'q1', city: 'qingdao', value: 0 },
  { id: 'q2', city: 'qingdao', value: 1 },
  { id: 'h1', city: 'hangzhou', value: 2 },
  { id: 'h2', city: 'hangzhou', value: 3 },
...
;[
  ...
  { id: 'h1', city: 'hangzhou', value: 2 },
  { id: 'h2', city: 'hangzhou', value: 3 },
]`,lang:"javascript"}),e.createElement("h5",{id:"removeindex-\u6839\u636E-index-\u79FB\u9664\u6570\u636E"},e.createElement(a.AnchorLink,{to:"#removeindex-\u6839\u636E-index-\u79FB\u9664\u6570\u636E","aria-hidden":"true",tabIndex:-1},e.createElement("span",{className:"icon icon-link"})),"removeIndex \u6839\u636E index \u79FB\u9664\u6570\u636E"),e.createElement(t.Z,{code:`const initialValue = [
  { id: 'q1', city: 'qingdao', value: 0 },
  { id: 'q2', city: 'qingdao', value: 1 },
  { id: 'h1', city: 'hangzhou', value: 2 },
  { id: 'h2', city: 'hangzhou', value: 3 },
...
;[
  ...
  { id: 'h1', city: 'hangzhou', value: 2 },
  { id: 'h2', city: 'hangzhou', value: 3 },
]`,lang:"javascript"}),e.createElement("h4",{id:"\u94FE\u5F0F\u8BED\u6CD5\u8FDB\u884C\u6570\u636E\u5904\u7406"},e.createElement(a.AnchorLink,{to:"#\u94FE\u5F0F\u8BED\u6CD5\u8FDB\u884C\u6570\u636E\u5904\u7406","aria-hidden":"true",tabIndex:-1},e.createElement("span",{className:"icon icon-link"})),"\u94FE\u5F0F\u8BED\u6CD5\u8FDB\u884C\u6570\u636E\u5904\u7406"),e.createElement("p",null,"\u4F7F\u7528\u94FE\u5F0F\u8BED\u6CD5\u53EF\u4EE5\u65B9\u4FBF\u7684\u5C06\u590D\u6742\u7684\u6570\u636E\u5904\u7406\u5199\u7684\u7B80\u6D01\u6E05\u6670"),e.createElement(t.Z,{code:`const initialValue = [
  { id: 'q1', city: 'qingdao', value: 0 },
  { id: 'q2', city: 'qingdao', value: 1 },
  { id: 'h1', city: 'hangzhou', value: 2 },
  { id: 'h2', city: 'hangzhou', value: 3 },
...
// \u6839\u636E\u4E0B\u6807\u79FB\u9664\u6307\u5B9Aitem
removeIndex: (value: number) => this`,lang:"javascript"})))});h.default=i=>{var v=e.useContext(a.context),p=v.demos;return e.useEffect(()=>{var o;i!=null&&(o=i.location)!==null&&o!==void 0&&o.hash&&a.AnchorLink.scrollToAnchor(decodeURIComponent(i.location.hash.slice(1)))},[]),e.createElement(g,{demos:p})}},92637:function(D,h,r){"use strict";var e=r(62472),a=r(29087),t=r.n(a),F=r(67052),g=r.n(F);function i(u,l){return f(u)||_(u,l)||p(u,l)||v()}function v(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
