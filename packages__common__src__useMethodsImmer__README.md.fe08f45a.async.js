          ...
          return u.createElement(
            ...
            u.createElement(
              ...
              u.createElement(
                ...
                u.createElement(
                  n.AnchorLink,
                  { to: '#usemethodsimmer', 'aria-hidden': 'true', tabIndex: -1 },
                  u.createElement('span', { className: 'icon icon-link' }),
                ),
                'useMethodsImmer',
              ),
              u.createElement('p', null, 'useMethods \u7684 immer \u7248\u672C'),
              u.createElement(
                'p',
                null,
              ...
              u.createElement(
                'p',
                null,
                '\u76EE\u524D\u5B9E\u73B0\u4E86\u4E24\u4E2A\u7248\u672C(immer \u7248\u672C\u548C\u666E\u901A\u7248\u672C)\u3002 \u5F53\u4F60\u9700\u8981\u4F7F\u7528 useReducer \u7684\u65F6\u5019\uFF0C\u53EF\u4EE5\u76F4\u63A5\u4F7F\u7528\u8FD9\u4E2A hooks \u6765\u66FF\u4EE3\u3002\u5F53\u6570\u636E\u662F obj \u683C\u5F0F\u7684\u65F6\u5019\uFF0C\u4E5F\u53EF\u4EE5\u4F7F\u7528 useObjectState',
              ),
              u.createElement(
                'h3',
                { id: '\u666E\u901A\u7248\u672C' },
                u.createElement(
                  n.AnchorLink,
                  { to: '#\u666E\u901A\u7248\u672C', 'aria-hidden': 'true', tabIndex: -1 },
                  u.createElement('span', { className: 'icon icon-link' }),
                ),
                '\u666E\u901A\u7248\u672C',
              ),
              u.createElement(c.Z, {
                code: `const counterReducers = {
  inc: (value) => value + 1,
  dec: (value) => value - 1,
}
    ...
    <div>
      ...
      <button onClick={() => dec()}>dec</button>
              ...
              u.createElement(
                ...
                u.createElement(
                  n.AnchorLink,
                  { to: '#immer-\u7248\u672C', 'aria-hidden': 'true', tabIndex: -1 },
                  u.createElement('span', { className: 'icon icon-link' }),
                ),
                'immer \u7248\u672C',
              ),
              ...
              u.createElement(c.Z, {
                code: `const counterReducers = state => ({
  inc: (value) => (value += 1),
  dec: (value) => (value -= 1)
})
