;(self.webpackChunk_brick_hooks_root = self.webpackChunk_brick_hooks_root || []).push([
          ...
          return e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(
                  n.AnchorLink,
                  { to: '#useanimate', 'aria-hidden': 'true', tabIndex: -1 },
                  e.createElement('span', { className: 'icon icon-link' }),
                ),
                'useAnimate',
              ),
              e.createElement('p', null, '\u65B9\u4FBF\u4F7F\u7528 react-native Animated'),
              e.createElement(
                'h3',
                { id: '\u7C7B\u578B\u58F0\u660E' },
                e.createElement(
              ...
              e.createElement(t.Z, {
                code: `function useAnimate(options: {
  ...
  return <Animated.View style={{ ...baseStyle, ...styleProps }} />
              ...
              e.createElement(
                'h4',
                {
                  id: '\u8BBE\u7F6E\u5FAA\u73AF\u6B21\u6570\u52A8\u753B\u6301\u7EED\u65F6\u95F4\u5EF6\u8FDF\u65F6\u95F4\u624B\u52A8\u89E6\u53D1\u7B49',
                },
                e.createElement(
                  n.AnchorLink,
                  {
                    to: '#\u8BBE\u7F6E\u5FAA\u73AF\u6B21\u6570\u52A8\u753B\u6301\u7EED\u65F6\u95F4\u5EF6\u8FDF\u65F6\u95F4\u624B\u52A8\u89E6\u53D1\u7B49',
                    'aria-hidden': 'true',
                    tabIndex: -1,
                  },
                  e.createElement('span', { className: 'icon icon-link' }),
              ...
              e.createElement(t.Z, {
                code: `import { Easing, View } from 'react-native'
function MyComponent() {
    ...
    <View>
      ...
      <Button onClick={() => start()}>Start</Button>
              ...
              e.createElement(
                ...
                e.createElement(
                  n.AnchorLink,
                  { to: '#\u8BBE\u7F6E\u66F2\u7EBF', 'aria-hidden': 'true', tabIndex: -1 },
                  e.createElement('span', { className: 'icon icon-link' }),
                ),
                '\u8BBE\u7F6E\u66F2\u7EBF',
              ),
              ...
              e.createElement(t.Z, {
                code: "type easing = 'linear'| 'ease'|'quad'|'cubic'|'sin'|'circle'|'exp'|'bounce'|'in'| 'out'| 'inOut' | ((...any[]) => any);",
                lang: 'typescript',
              }),
              e.createElement(
                'p',
  ...
  return <Animated.View style={{ ...baseStyle, ...styleProps }} />
              ...
              e.createElement(
                ...
                e.createElement(
                  n.AnchorLink,
                  { to: '#\u8BBE\u7F6E\u591A\u4E2A-keyframe', 'aria-hidden': 'true', tabIndex: -1 },
                  e.createElement('span', { className: 'icon icon-link' }),
                ),
                '\u8BBE\u7F6E\u591A\u4E2A keyframe',
              ),
    ...
    <View>
      ...
      <Button onClick={() => start()}>Start</Button>
              ...
              e.createElement(
                ...
                e.createElement(
                  n.AnchorLink,
                  { to: '#\u7528\u6CD5-transform', 'aria-hidden': 'true', tabIndex: -1 },
                  e.createElement('span', { className: 'icon icon-link' }),
                ),
                '\u7528\u6CD5 transform',
              ),
              e.createElement(
                'p',
                null,
                '\u57FA\u672C\u4E0A\u5927\u591A\u6570\u7684\u6837\u5F0F\u90FD\u53EF\u4EE5\u76F4\u63A5\u50CF\u7F16\u5199 React-native \u7EC4\u4EF6\u4E2D\u7684 style \u4E00\u6837\u4F7F\u7528\uFF0C\u4F46\u662F transform \u4F8B\u5916\u3002\u4EE5\u4E0B transform-functions \u76F4\u63A5\u4F7F\u7528\uFF0C\u65E0\u9700\u7C7B\u4F3C',
                '{',
                ' transform: [',
                '{',
                ' rotateX: 0 ',
                ...
                '] ',
                '}',
                ' \u8FD9\u6837\u4F7F\u7528 matrix\u3001perspective\u3001rotate\u3001rotateX\u3001rotateY\u3001rotateZ\u3001scale\u3001scaleX\u3001scaleY\u3001translateX\u3001translateY\u3001skewX\u3001skewY',
              ),
              e.createElement(t.Z, {
                code: `function MyComponent() {
  const [styleProps, { start }] = useAnimate({
