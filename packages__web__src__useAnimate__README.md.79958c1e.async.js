        ...
        s = e.memo((u) => {
          ...
          return e.createElement(
            ...
            e.createElement(
              ...
              e.createElement('p', null, '\u65B9\u4FBF\u5728 web \u4E2D\u4F7F\u7528 animate'),
              e.createElement(
                'p',
                null,
  ...
  return (
    <div>
      ...
      <Button onClick={() => start()}>Start</Button>
              ...
              e.createElement(
                'h4',
                { id: '\u7528\u6CD5-keyframesname-\u6307\u5B9A\u5DF2\u6709-css' },
                e.createElement(
                  n.AnchorLink,
                  {
                    to: '#\u7528\u6CD5-keyframesname-\u6307\u5B9A\u5DF2\u6709-css',
                    'aria-hidden': 'true',
                    tabIndex: -1,
                  },
                  e.createElement('span', { className: 'icon icon-link' }),
...
@keyframes test {
  ...
  return <div style={{ ...baseStyle, ...styleProps }} />
              ...
              e.createElement(
                'h4',
                {
                  id: '\u8BBE\u7F6E\u5FAA\u73AF\u6B21\u6570\u52A8\u753B\u6301\u7EED\u65F6\u95F4\u5EF6\u8FDF\u65F6\u95F4\u7B49',
                },
                e.createElement(
                  n.AnchorLink,
                  {
                    to: '#\u8BBE\u7F6E\u5FAA\u73AF\u6B21\u6570\u52A8\u753B\u6301\u7EED\u65F6\u95F4\u5EF6\u8FDF\u65F6\u95F4\u7B49',
                    'aria-hidden': 'true',
                    tabIndex: -1,
                  },
                  e.createElement('span', { className: 'icon icon-link' }),
  ...
  return (
    <div>
      ...
      <Button onClick={() => start()}>Start</Button>
              ...
              e.createElement('p', null, "'linear', 'ease', 'in', 'out', 'inOut'"),
              e.createElement(t.Z, {
                code: `function MyComponent() {
  const [styleProps, { start }] = useAnimate({
    from: { opacity: 0, marginLeft: 0, width: 50, height: 50 },
