;(self.webpackChunk_brick_hooks_root = self.webpackChunk_brick_hooks_root || []).push([
          ...
          return e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(
                  n.AnchorLink,
                  { to: '#usescroll', 'aria-hidden': 'true', tabIndex: -1 },
  ...
  y: number
              ...
              e.createElement(
                ...
                e.createElement(
                  n.AnchorLink,
                  { to: '#\u9875\u9762\u6EDA\u52A8', 'aria-hidden': 'true', tabIndex: -1 },
                  e.createElement('span', { className: 'icon icon-link' }),
                ),
                '\u9875\u9762\u6EDA\u52A8',
              ),
...
function Comp() {
  ...
  const { y, scrollToTop } = useScroll()
              ...
              e.createElement(
                ...
                e.createElement(
                  n.AnchorLink,
                  { to: '#\u6307\u5B9A-root', 'aria-hidden': 'true', tabIndex: -1 },
                  e.createElement('span', { className: 'icon icon-link' }),
                ),
                '\u6307\u5B9A root',
              ),
        ...
        return (
          e.useEffect(() => {
            ...
            o != null &&
              ...
              l !== void 0 &&
              l.hash &&
              n.AnchorLink.scrollToAnchor(decodeURIComponent(o.location.hash.slice(1)))
          }, []),
          e.createElement(a, { demos: s })
        )
      }
    },
  },
