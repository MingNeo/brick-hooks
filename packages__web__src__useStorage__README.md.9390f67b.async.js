(self.webpackChunk_brick_hooks_root=self.webpackChunk_brick_hooks_root||[]).push([[3772],{74115:function(i,r,t){"use strict";t.r(r);var e=t(62472),a=t(34019),o=t(94834),u=e.memo(n=>{var c=n.demos;return e.createElement(e.Fragment,null,e.createElement("div",{className:"markdown"},e.createElement("h2",{id:"usestorage"},e.createElement(a.AnchorLink,{to:"#usestorage","aria-hidden":"true",tabIndex:-1},e.createElement("span",{className:"icon icon-link"})),"useStorage"),e.createElement("p",null,"\u65B9\u4FBF\u4F7F\u7528 localStorage \u548C sessionStorage"),e.createElement("h3",{id:"\u7C7B\u578B\u58F0\u660E"},e.createElement(a.AnchorLink,{to:"#\u7C7B\u578B\u58F0\u660E","aria-hidden":"true",tabIndex:-1},e.createElement("span",{className:"icon icon-link"})),"\u7C7B\u578B\u58F0\u660E"),e.createElement(o.Z,{code:`function useStorage(
  itemName: string,
  initialValue?: any,
  {
    watchStorageChange,
